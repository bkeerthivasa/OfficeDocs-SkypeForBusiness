...
- **List Transcripts:** Get all transcripts from scheduled onlineMeeting instances for which the specified user is the organizer. This API currently only supports private scheduled meetings.
- **List Recordings:** Get all transcripts from scheduled onlineMeeting instances for which the specified user is the organizer. This API currently only supports private scheduled meetings.
